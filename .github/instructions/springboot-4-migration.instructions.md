---
description: "Reference guide for explicit Spring Boot 3.x to 4.0 migration work; not intended for day-to-day development in repositories already on Spring Boot 4"
applyTo: ".github/migration/**"
---
# Spring Boot 3.x to 4.0 Migration Guide

> Repository note: `spring-petclinic` already runs on Spring Boot `4.0.3`. Keep this file only as a reference for explicit migration tasks, not as active guidance for routine edits.
## Project Context
